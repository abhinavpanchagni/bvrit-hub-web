...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-border/10 w-full pt-20 pb-10 flex flex-col items-center relative">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 md:px-12 relative z-10">
        <div className="flex flex-col items-center mb-16 text-center">
          ...
          <div className="text-text-secondary font-medium text-lg leading-relaxed">
            <p>The Student Platform for BVRIT.</p>
            <p>Built by students. Improved by the community.</p>
            <p>Designed for every BVRITian.</p>
          </div>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-10 w-full mb-16 text-left border border-border/10 rounded-[2.5rem] p-6 md:p-10 bg-black/5 shadow-sm">
          <div className="flex flex-col gap-4">
            ...
            <Link className="text-text-secondary hover:text-accent-blue font-medium transition-colors text-sm" href="/starter-pack">Starter Pack</Link>
          </div>
          <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4 lg:col-span-2">
            ...
            <Link className="text-text-secondary hover:text-accent-blue font-bold transition-colors text-sm" href="mailto:bvrithub@gmail.com">bvrithub@gmail.com</Link>
            <div className="mt-4 p-4 md:p-5 border border-border/10 rounded-2xl bg-surface-yellow/90 text-accent-black shadow-sm">
               <p className="font-extrabold text-sm mb-1">Have an idea or suggestion?</p>
               <p className="font-medium text-xs opacity-80">We're building BVRIT Hub together with the student community.</p>
            </div>
          </div>
        </div>

        <div className="flex items-center justify-center pt-6 border-t border-border/10 w-full">
          <p className="text-text-secondary font-medium text-xs text-center">© 2026 BVRIT Hub. Building a better campus experience, together.</p>
        </div>
      </div>
    </footer>
  );
