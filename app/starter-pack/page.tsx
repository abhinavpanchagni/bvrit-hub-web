  ...
  return (
    <main className="min-h-screen bg-bg text-text-primary">
      ...
      <section className="mx-auto max-w-7xl px-6 md:px-12 py-16 animate-fade-in-up">
        ...
        {/* Header Block */}
        <div className="rounded-[2.5rem] border border-border/10 bg-white p-10 md:p-14 shadow-sm mb-16">
          ...
          {chapters.map((chapter) => (
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <div className="rounded-xl bg-white/60 border border-white/20 w-12 h-12 flex items-center justify-center text-xl font-extrabold text-accent-black">
                  {chapter.number}
                </div>
                <span className="rounded-xl bg-white/60 border border-white/20 px-4 py-2 font-bold text-sm text-accent-black flex items-center gap-2">
