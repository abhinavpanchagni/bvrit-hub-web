    ...
    <main className="min-h-screen bg-bg text-text-primary p-6 md:p-12 animate-fade-in-up">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="space-y-10">
          ...
          <div className="rounded-[2.5rem] border border-border/10 bg-white p-10 md:p-14 shadow-sm">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-[2.5rem] border border-border/10 bg-surface-mint/40 p-10 shadow-sm flex flex-col">
              <div className="w-12 h-12 rounded-xl bg-white/60 flex items-center justify-center mb-6 shadow-sm border border-white/20">
          ...
          <div className="rounded-[2.5rem] border border-border/10 bg-surface-peach/40 p-10 md:p-14 shadow-sm flex flex-col md:flex-row gap-8 items-start">
            <div className="w-16 h-16 rounded-2xl border border-border/10 shadow-sm bg-white/60 flex items-center justify-center shadow-sm border border-white/20 shrink-0">
