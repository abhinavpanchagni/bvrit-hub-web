  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="inline-flex rounded-xl border-2 border-black bg-[#FFE17C] px-5 py-2 font-bold shadow-[5px_5px_0px_#000]">
          STUDENT LIFE @ BVRIT
        </div>
        ...
        <div className="mt-12 flex flex-wrap gap-5">
          ...
          <div className="rounded-2xl border-2 border-black bg-white px-8 py-5 shadow-[6px_6px_0px_#000]">
      ...
      <section className="mx-auto max-w-7xl px-6">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          {categories.map((item) => (
            <button
              key={item}
              className="rounded-full border-2 border-black bg-white px-6 py-3 font-bold transition hover:bg-black hover:text-white"
            >
              {item}
            </button>
          ))}
      ...
      <section className="mx-auto mt-20 max-w-7xl px-6">
        ...
        <div className="rounded-3xl border-2 border-black bg-[#FFE17C] p-10 shadow-[10px_10px_0px_#000]">

          <div className="flex flex-col gap-12 lg:flex-row">

            <div className="flex-1">

              <span className="rounded-lg border-2 border-black bg-white px-4 py-2 font-bold">
            ...
            <div className="w-full rounded-2xl border-2 border-black bg-white p-8 lg:w-[380px]">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                {[
                  ...
                  <span
                    key={item}
                    className="rounded-full border-2 border-black px-4 py-2 font-bold"
                  >
                    {item}
                  </span>
                ))}
              ...
              <div className="mt-10 space-y-4">
                ...
                <button className="w-full rounded-xl border-2 border-black bg-black py-4 font-bold text-white">
                  Visit Website
                </button>

                <button className="w-full rounded-xl border-2 border-black bg-white py-4 font-bold">
                  Instagram
                </button>
      ...
      <section className="mx-auto mt-24 max-w-7xl px-6">
        ...
        <div className="mb-10 flex items-center justify-between">
          ...
          <div>
            <h2 className="text-5xl font-black">Technical Clubs</h2>
            <p className="mt-3 text-lg">
              Learn technology, coding, AI and software development.
            </p>
          </div>

          <div className="rounded-xl border-2 border-black bg-[#B7C6C2] px-5 py-2 font-bold">
            3 Clubs
          </div>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          {clubs
            ...
            .map((club) => (
              ...
              <div
                key={club.name}
                className="rounded-3xl border-2 border-black bg-white p-8 shadow-[8px_8px_0px_#000]"
              >

                <div className="flex items-center justify-between">

                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-black bg-[#FFE17C] text-3xl">
                    {club.icon}
                  </div>

                  <span className="rounded-full border-2 border-black bg-[#B7C6C2] px-4 py-2 text-sm font-bold">
                    {club.status}
                  </span>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  {club.skills.map((skill) => (
                    <span
                      key={skill}
                      className="rounded-full border-2 border-black px-4 py-2 text-sm font-bold"
                    >
                      {skill}
                    </span>
                  ))}
                ...
                <div className="mt-8 rounded-xl border-2 border-black bg-[#f8f8f8] p-5">

                  <p className="font-black">Quick Information</p>
                ...
                <div className="mt-8 grid grid-cols-2 gap-3">
                  ...
                  <button className="rounded-xl border-2 border-black bg-black py-3 font-bold text-white">
                    Learn More
                  </button>

                  <button className="rounded-xl border-2 border-black py-3 font-bold">
                    Join
                  </button>

                  <button
                    disabled={!club.instagram}
                    className="rounded-xl border-2 border-black py-3 font-bold disabled:cursor-not-allowed disabled:opacity-40"
                  >
                    Instagram
                  </button>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          {clubs
            ...
            .map((club) => (
              ...
              <div
                key={club.name}
                className="rounded-3xl border-2 border-black bg-[#FFE17C] p-10 shadow-[8px_8px_0px_#000]"
              >
                ...
                <div className="mt-10 flex gap-4">
                  ...
                  <button className="rounded-xl border-2 border-black bg-black px-6 py-3 font-bold text-white">
                    Learn More
                  </button>

                  <button className="rounded-xl border-2 border-black bg-white px-6 py-3 font-bold">
                    Instagram
                  </button>
      ...
      <section className="mx-auto mt-24 max-w-7xl px-6">
        ...
        <div className="mb-10 flex items-center justify-between">
          ...
          <div>
            <h2 className="text-5xl font-black">Communication & Leadership</h2>
            <p className="mt-3 text-lg">
              Become a confident speaker, leader and communicator.
            </p>
          </div>

          <div className="rounded-xl border-2 border-black bg-[#FFE17C] px-5 py-2 font-bold">
            2 Clubs
          </div>
            ...
            .map((club) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="rounded-full border-2 border-black bg-[#B7C6C2] px-4 py-2 font-bold">
                    {club.status}
                  </span>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          {clubs
            ...
            .map((club) => (
              ...
              <div
                key={club.name}
                className="rounded-3xl border-2 border-black bg-[#B7C6C2] p-8 shadow-[8px_8px_0px_#000]"
              >
                ...
                <button className="mt-10 rounded-xl border-2 border-black bg-white px-6 py-3 font-bold">
                  Learn More
                </button>
      ...
      <section className="mx-auto mt-24 max-w-7xl px-6">
        ...
        {clubs
          ...
          .map((club) => (
            ...
            <div
              key={club.name}
              className="rounded-3xl border-2 border-black bg-white p-10 shadow-[8px_8px_0px_#000]"
            >
              ...
              <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="space-y-4">
                  ...
                  <button className="w-60 rounded-xl border-2 border-black bg-black py-4 font-bold text-white">
                    Learn More
                  </button>

                  <button className="w-60 rounded-xl border-2 border-black bg-[#FFE17C] py-4 font-bold">
                    Volunteer
                  </button>
      ...
      <section className="mx-auto mt-24 max-w-7xl px-6 pb-20">
        ...
        <div className="rounded-3xl border-2 border-black bg-black p-14 text-center text-white shadow-[10px_10px_0px_#000]">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-5">
            ...
            <Link
              href="/community"
              className="rounded-xl border-2 border-white bg-white px-8 py-4 font-bold text-black transition hover:-translate-y-1"
            >
              Explore Community
            </Link>
