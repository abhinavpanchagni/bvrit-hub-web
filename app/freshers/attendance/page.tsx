...
export default function AttendancePage() {
  return (
    <main className="min-h-screen bg-[#f6f6f6]">
      {/* Hero */}
      <section className="border-b-4 border-black bg-red-500 text-white">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-10 rounded-3xl border-4 border-black bg-blue-600 p-8 text-white shadow-[8px_8px_0_#000] md:p-10">
          ...
          <div className="mt-8 rounded-2xl border-2 border-black bg-white p-6 text-gray-700">
            <p className="text-xl font-black">
        ...
        <div className="mt-10 rounded-3xl border-4 border-black bg-white p-8 shadow-[8px_8px_0_#000] md:p-10">
          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="rounded-2xl border-2 border-black bg-blue-200 p-6">
              <h4 className="text-xl font-black">
        ...
        <div className="mt-10 rounded-3xl border-4 border-black bg-black p-8 text-white shadow-[8px_8px_0_#ef4444] md:p-10">
          <h3 className="text-4xl font-black">
            🚀 Final Tip
          </h3>
