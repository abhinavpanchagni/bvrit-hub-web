...
export default function LabsPage() {
  return (
    <main className="min-h-screen bg-[#f6f6f6]">
      {/* Hero */}
      <section className="border-b-4 border-black bg-emerald-600 text-white">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="rounded-3xl border-4 border-black bg-white p-8 shadow-[10px_10px_0_#000] md:p-10">
          <h2 className="text-4xl font-black">🔬 What Are Labs?</h2>

          <p className="mt-6 text-lg leading-9 text-black">
            Labs are where engineering becomes practical.
          </p>

          <p className="mt-4 text-lg leading-9 text-black">
          ...
          <div className="mt-8 rounded-2xl border-4 border-black bg-yellow-300 p-7 text-center">
        ...
        <div className="mt-10 rounded-3xl border-4 border-black bg-blue-300 p-8 shadow-[8px_8px_0_#000] md:p-10">
          ...
          <div className="mt-8 rounded-2xl border-4 border-black bg-white p-8 text-center">
            <p className="text-6xl font-black">4–5</p>
        ...
        <div className="mt-10 rounded-3xl border-4 border-black bg-pink-300 p-8 shadow-[8px_8px_0_#000] md:p-10">
          <h3 className="text-4xl font-black">🥼 Lab Dress Code</h3>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border-4 border-black bg-white p-7">
              <h4 className="text-2xl font-black">White Apron</h4>
              <p className="mt-3 text-lg leading-8">
                Required for certain labs such as Engineering Chemistry.
              </p>
            </div>

            <div className="rounded-2xl border-4 border-black bg-blue-500 p-7 text-white">
              <h4 className="text-2xl font-black">Blue Apron</h4>
              <p className="mt-3 text-lg leading-8">
        ...
        <div className="mt-10 rounded-3xl border-4 border-black bg-orange-300 p-8 shadow-[8px_8px_0_#000] md:p-10">
          <h3 className="text-4xl font-black">🎒 What Should You Bring?</h3>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border-4 border-black bg-green-300 p-8 shadow-[8px_8px_0_#000]">
            <h3 className="text-3xl font-black">💡 Pro Tips</h3>
        ...
        {/* Lab Pack */}
        <div className="mt-10 rounded-3xl border-4 border-black bg-emerald-600 p-8 text-white shadow-[8px_8px_0_#000] md:p-10">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={item}
                className="rounded-2xl border-2 border-black bg-white p-5 text-gray-700"
              >
        ...
        {/* Final Tip */}
        <div className="mt-10 rounded-3xl border-4 border-black bg-black p-8 text-white shadow-[8px_8px_0_#059669] md:p-10">
